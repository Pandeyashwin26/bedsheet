...
logger = get_logger("agrimitra.routers.sms")
...
def _handle_score() -> str:
    return (
        ...
        f"App: agrimitra.app/score"
    )


def _handle_help() -> str:
    return (
        f"AGRIMITRA COMMANDS\n"
        f"PRICE <crop>\n"
        f"WEATHER <district>\n"
        f"HARVEST <crop>\n"
        f"DISEASE <crop> <sign>\n"
...
def list_sms_commands() -> Dict[str, Any]:
    ...
    return {
        ...
        "max_sms_length": 160,
        "help_text": "Send any command to AGRIMITRA number. Example: PRICE ONION",
    }
