...
logger = get_logger("agrimitra.routers.aria")
...
class AriaChatRequest(BaseModel):
    ...
    language_code: str = Field(default="hi", examples=["hi", "en", "mr"])
...
def _normalize_language(code: str) -> str:
    ...
    return safe if safe in ("hi", "en", "mr") else "en"
